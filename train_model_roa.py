...
# -----------------------------
# 2️⃣ Split Data BEFORE Balancing
# -----------------------------
...
# -----------------------------
# 3️⃣ Apply SMOTE to Training Data
# -----------------------------
...
# -----------------------------
# 4️⃣ Define Fitness Function for ROA
# -----------------------------
def fitness_function(params):
    ...
    model = RandomForestClassifier(
        ...
        max_depth=max_depth,
        min_samples_leaf=2,   # safer parameter
        random_state=42
    )
...
# -----------------------------
# 5️⃣ Remora Optimization Algorithm
# -----------------------------
